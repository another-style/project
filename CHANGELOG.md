...
- **Кнопка «Сослаться на этот комментарий»** — в карточке комментария появилась кнопка, которая вставляет `>>ID` в текстовую область ответа (с учётом позиции курсора). Если форма ответа не открыта — открывает её с уже вставленной ссылкой.

### Улучшено
- **Вёрстка панели действий комментария** — кнопка «Сослаться на этот комментарий» и подсказка «Выделите текст и нажмите «Ответить»...» вынесены в отдельную строку, что исправляет переполнение на маленьких экранах.
